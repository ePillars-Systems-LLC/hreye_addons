...
class HrEmployeePublicProfile(models.Model):
    _inherit = 'hr.employee.public'


    passport_id = fields.Char(related='employee_id.passport_id')
    passport_start_date = fields.Date(related='employee_id.passport_start_date')
    passport_expiry_date = fields.Date(related='employee_id.passport_expiry_date')

    visa_no = fields.Char(related='employee_id.visa_no')
    visa_start_date = fields.Date(related='employee_id.visa_start_date')
    visa_end_date = fields.Date(related='employee_id.visa_end_date')

    labour_card_no = fields.Char(related='employee_id.labour_card_no')
    labour_card_issue_date = fields.Date(related='employee_id.labour_card_issue_date')
    labour_card_expiry_date = fields.Date(related='employee_id.labour_card_expiry_date')

    health_card_no = fields.Char(related='employee_id.health_card_no')
    health_card_issue_date = fields.Date(related='employee_id.health_card_issue_date')
    health_card_expiry_date = fields.Date(related='employee_id.health_card_expiry_date')

    emirates_id_no = fields.Char(related='employee_id.emirates_id_no')
    emirates_id_expiry_date = fields.Date(related='employee_id.emirates_id_expiry_date')
    contract_type = fields.Selection(related='employee_id.contract_type')

    attendance_checked_in = fields.Char(related='employee_id.attendance_checked_in')

    airticket_allowance = fields.Selection(related='employee_id.airticket_allowance')
    airticket_allowance_amount = fields.Float(related='employee_id.airticket_allowance_amount')

    number_of_persons_eligible = fields.Integer(related='employee_id.number_of_persons_eligible')
